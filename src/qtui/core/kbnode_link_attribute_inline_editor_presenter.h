...
#ifndef KBNODE_LINK_ATTRIBUTE_INLINE_EDITOR_PRESENTER_H_
#define KBNODE_LINK_ATTRIBUTE_INLINE_EDITOR_PRESENTER_H_
...
#endif  // KBNODE_LINK_ATTRIBUTE_INLINE_EDITOR_PRESENTER_H_
