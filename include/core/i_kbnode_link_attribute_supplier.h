...
#ifndef INCLUDE_CORE_I_KBNODE_LINK_ATTRIBUTE_SUPPLIER_H_
#define INCLUDE_CORE_I_KBNODE_LINK_ATTRIBUTE_SUPPLIER_H_
...
#endif  // INCLUDE_CORE_I_KBNODE_LINK_ATTRIBUTE_SUPPLIER_H_
