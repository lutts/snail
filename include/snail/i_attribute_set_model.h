...
class IAttributeSetModel : public pfmvp::IPfModel {
 public:
  ...
  SNAIL_SIGSLOT_PURE_VIRTUAL(SwitchToEditMode, void());
  SNAIL_SIGSLOT_PURE_VIRTUAL(SwitchToDisplayMode, void());
  SNAIL_SIGSLOT_PURE_VIRTUAL(ValidateComplete, void(bool validate_result));
