...
#ifndef INCLUDE_QTUI_MOCK_KBNODE_LINK_ATTRIBUTE_INLINE_EDITOR_VIEW_H_
#define INCLUDE_QTUI_MOCK_KBNODE_LINK_ATTRIBUTE_INLINE_EDITOR_VIEW_H_
...
#endif  // INCLUDE_QTUI_MOCK_KBNODE_LINK_ATTRIBUTE_INLINE_EDITOR_VIEW_H_
