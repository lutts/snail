...
ActionGroup::ActionGroup(QWidget *parent)
  : QWidget(parent)
{
    myHeader = new TaskHeader(QPixmap(), QStringLiteral(""), false, this);
...
QBoxLayout* ActionGroup::headerLayout() {
  return myHeader->headerLayout();
}
...
void ActionGroup::setHasEditButton(bool has_edit_button) {
