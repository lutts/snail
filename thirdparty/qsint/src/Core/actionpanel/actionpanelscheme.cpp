...
ActionPanelScheme::ActionPanelScheme()
{
    ...
    headerButtonFold = QPixmap(QStringLiteral(":/default/Fold.png"));
    headerButtonFoldOver = QPixmap(QStringLiteral(":/default/FoldOver.png"));
    headerButtonUnfold = QPixmap(QStringLiteral(":/default/Unfold.png"));
    headerButtonUnfoldOver = QPixmap(QStringLiteral(":/default/UnfoldOver.png"));
    ...
    actionStyle = QString::fromLatin1(ActionPanelDefaultStyle);
}
